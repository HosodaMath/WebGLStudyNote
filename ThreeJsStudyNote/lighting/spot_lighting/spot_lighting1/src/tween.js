...
class Group {
  constructor() {
    (this.tweens = {}), (this.tweensAddedDuringUpdate = {});
  }
  getAll() {
    return Object.keys(this.tweens).map(
      function (t) {
  ...
  add(t) {
    (this.tweens[t.getId()] = t), (this.tweensAddedDuringUpdate[t.getId()] = t);
  }
  remove(t) {
    delete this.tweens[t.getId()],
      delete this.tweensAddedDuringUpdate[t.getId()];
  }
  update(t, n) {
    var e = Object.keys(this.tweens);
    if (0 === e.length) return !1;
    for (t = void 0 !== t ? t : TWEEN.now(); 0 < e.length; ) {
      this.tweensAddedDuringUpdate = {};
      for (var i = 0; i < e.length; i++) {
        var r = this.tweens[e[i]];
        r &&
          !1 === r.update(t) &&
          ((r._isPlaying = !1), n || delete this.tweens[e[i]]);
      }
      e = Object.keys(this.tweensAddedDuringUpdate);
    }
    return !0;
  }
}

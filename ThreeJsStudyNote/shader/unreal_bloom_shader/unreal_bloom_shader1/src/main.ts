...
import SphereVertexShader from "./shader/sphere.vert";
import SphereFragmentShader from "./shader/sphere.frag";
...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  // fragmentShader or vertexShaderのuniform
  let uniforms: {
    time: {
      value: number;
    };
  ...
  const drawFloor = () => {
    ...
    const floorGeometry = new THREE.BoxBufferGeometry(200, 0.1, 200);

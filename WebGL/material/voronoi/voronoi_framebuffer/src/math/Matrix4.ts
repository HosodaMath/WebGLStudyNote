export class Matrix4 {
  ...
  static scale(
    ...
    out[2] = matrix[2] * vector[0];
    out[3] = matrix[3] * vector[0];
    out[4] = matrix[4] * vector[1];
    out[5] = matrix[5] * vector[1];
    out[6] = matrix[6] * vector[1];
    out[7] = matrix[7] * vector[1];
    out[8] = matrix[8] * vector[2];
    out[9] = matrix[9] * vector[2];
    out[10] = matrix[10] * vector[2];
    out[11] = matrix[11] * vector[2];
    out[12] = matrix[12];
    out[13] = matrix[13];
    out[14] = matrix[14];
    out[15] = matrix[15];

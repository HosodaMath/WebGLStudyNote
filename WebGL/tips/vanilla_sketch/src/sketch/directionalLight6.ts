...
import DirectionalLightVertexShader from "../lib/shader/light/directionalLight/directionalLight6.vert?raw";
import DirectionalLightFragmentShader from "../lib/shader/light/directionalLight/directionalLight6.frag?raw";
...
const sketch = () => {
  ...
  const waterProgram = createProgram(gl, waterVetexShader, waterFragmentShader);
  ...
  const animation = () => {
    ...
    const sphereCount1 = sphereVAO.indicesData.length;
    ...
    const sphereCount2 = sphereVAO.indicesData.length;

...
import { rectData } from "../data/rectangle/rectData1";
...
export const sketch2 = () => {
  ...
  const verticesColor = rectData[0].vertexColor;
  const verticesData = rectData[0].verticesData;
  const attributeSize = rectData[0].attributeSize;
  const indicesData = rectData[0].indicesData;
